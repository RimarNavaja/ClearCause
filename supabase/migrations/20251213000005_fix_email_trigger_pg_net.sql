-- Migration: Fix Webhook Trigger using pg_net (Retry)
-- Date: 2025-12-13

-- Enable pg_net extension if not already enabled (usually in 'extensions' schema)
...
BEGIN
  ...
  -- Authorization token is the long-lived ANON key found in your project
...
EXCEPTION WHEN OTHERS THEN
  ...
  RAISE WARNING 'Failed to trigger email notification via pg_net: %', SQLERRM;
  RETURN NEW;
END;
