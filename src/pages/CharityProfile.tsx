...
const CHARITY_INFO = {
  ...
  description:
    "Water For All Foundation is committed to providing clean, safe drinking water to communities in need around the world. We believe that access to clean water is a fundamental human right that plays a critical role in public health, education, and economic development.",
...
const ACTIVE_CAMPAIGNS = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1594398901394-4e34939a4fd0?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    charity: "Water For All Foundation",
    description:
      "Install water filtration systems in 20 schools, providing clean drinking water to over 10,000 students.",
    raised: 275000,
    goal: 450000,
    daysLeft: 45,
    verified: true,
...
const PAST_CAMPAIGNS = [
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1544476915-ed1370594142?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    charity: "Water For All Foundation",
    description:
      "Provided emergency water supplies to communities affected by the recent typhoon.",
    raised: 500000,
    goal: 500000,
    daysLeft: 0,
    verified: true,
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1532619675605-1ede6c2ed2b0?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    charity: "Water For All Foundation",
    description:
      "Educated 5,000 people about water conservation and hygiene practices.",
    raised: 350000,
    goal: 300000,
    daysLeft: 0,
    verified: true,
...
const CharityProfile: React.FC = () => {
  ...
  if (error || !charity) {
    return (
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-2xl font-robotobold text-gray-900 mb-2">
              Charity Not Found
            </h2>
            <p className="text-gray-600 mb-4">
              {error || "The charity you are looking for does not exist."}
            </p>
            <button
              onClick={() => navigate("/")}
  ...
  return (
    <div className="flex flex-col min-h-screen font-poppinsregular">
      <Navbar />
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <img
                  src={
                    ...
                    "https://ui-avatars.com/api/?name=" +
                      encodeURIComponent(charity.organizationName) +
              ...
              <div className="flex-1">
                <div className="flex items-center flex-wrap gap-2 mb-2">
                  <h1 className="text-3xl font-robotobold text-gray-900">
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mt-3">
                  ...
                  {charity.createdAt && (
                    <div className="flex items-center">
                      ...
                      <span>
                        Founded: {new Date(charity.createdAt).getFullYear()}
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                  <h2 className="text-xl font-robotobold mb-4">About</h2>
                ...
                {activeCampaigns.length > 0 && (
                  <div className="space-y-4">
                    <div className="flex justify-between items-end">
                      <h2 className="text-xl font-robotobold">
                        Active Campaigns
                      </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {activeCampaigns.map((campaign) => (
                        ...
                        >
                          ...
                          <div className="p-4">
                            <h3 className="font-robotobold text-lg mb-2 line-clamp-2">
                              {campaign.title}
                            </h3>
                            <div className="mb-3">
                ...
                {completedCampaigns.length > 0 && (
                  <div className="space-y-4">
                    <div className="flex justify-between items-end">
                      <h2 className="text-xl font-robotobold">Past Campaigns</h2>
                    </div>
                          ...
                          <div className="p-4">
                            ...
                            <div className="mb-3">
                              ...
                              <Progress
                                ...
                                className="h-2 bg-clearcause-muted"
                              />
                            </div>
                            <div className="flex justify-between text-sm text-gray-500">
                              <span>{campaign.category || "General"}</span>
