      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
          ...
          <div className="absolute top-10 right-10 opacity-20">
            <img src="/decoration-7.png" alt="" className="w-32 h-32" />
          </div>
          <div className="absolute bottom-20 left-10 opacity-30">
            <img src="/caminho-pink.png" alt="" className="w-24 h-24" />
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                  ...
                  <br />
                  <span className="text-blue-600">Track every pesos</span>, see the impact.
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/campaigns">
                    <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-lg">
                      Browse Campaigns
                    </Button>
                  </Link>
                  <Link to="/how-it-works">
                    <Button size="lg" variant="outline" className="text-blue-600 border-blue-600 hover:bg-blue-50 font-semibold px-8 py-4 rounded-lg">
                      How It Works
                    </Button>
                  </Link>
                </div>
              ...
              <div className="relative">
                ...
                />
                <div className="absolute -right-6 -bottom-6 bg-white p-6 rounded-xl shadow-xl border border-gray-100 max-w-xs">
        ...
        <section className="py-20 bg-white relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How ClearCause Works</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-blue-50 rounded-2xl p-8 text-center hover:shadow-lg transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-4 text-gray-900">Verified Campaigns</h3>
              ...
              <div className="bg-blue-50 rounded-2xl p-8 text-center hover:shadow-lg transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-4 text-gray-900">Milestone-Based Funding</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="mt-12 text-center">
              <Link to="/how-it-works" className="inline-flex items-center text-blue-600 hover:text-blue-700 font-semibold text-lg transition-colors">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center mb-12">
              ...
              <Link to="/campaigns" className="text-blue-600 hover:text-blue-700 font-semibold flex items-center text-lg">
                View all campaigns
                <ChevronRight className="ml-2 h-5 w-5" />
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-700 rounded-3xl overflow-hidden shadow-2xl">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="p-8 md:p-12 lg:p-16">
                  <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Our Transparency Promise</h2>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <p className="ml-4 text-white/90 text-lg">100% verified milestones before fund release</p>
                    </div>
                    <div className="flex items-start">
                      <div className="flex-shrink-0 h-8 w-8 rounded-full bg-white/20 flex items-center justify-center mt-1">
                        <Check className="h-4 w-4 text-white" />
                      </div>
                      <p className="ml-4 text-white/90 text-lg">Real-time impact tracking for every donation</p>
                    </div>
                    <div className="flex items-start">
                      <div className="flex-shrink-0 h-8 w-8 rounded-full bg-white/20 flex items-center justify-center mt-1">
                        <Check className="h-4 w-4 text-white" />
                      </div>
                      <p className="ml-4 text-white/90 text-lg">Only 1-3% platform fee, much lower than industry average</p>
                    </div>
                  </div>
                  <div className="mt-10">
                    <Link to="/about">
                      <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 font-semibold px-8 py-4 rounded-lg">
                        Learn More
                      </Button>
                    </Link>
                  </div>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Ready to make a transparent impact?</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link to="/campaigns">
                <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-10 py-4 rounded-lg">
                  Browse Campaigns
                </Button>
              </Link>
              <Link to="/signup">
                <Button size="lg" variant="outline" className="text-blue-600 border-blue-600 hover:bg-blue-50 font-semibold px-10 py-4 rounded-lg">
                  Create Account
                </Button>
              </Link>
            </div>
