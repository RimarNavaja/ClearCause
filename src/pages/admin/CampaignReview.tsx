  ...
  const executeAction = async () => {
    ...
    try {
      ...
      switch (actionDialog.type) {
        case "approve":
          result = await campaignService.approveCampaign(campaign.id, user.id, {
        ...
        case "reject":
          ...
          result = await campaignService.rejectCampaign(campaign.id, user.id, {
            reason: actionReason,
  ...
  return (
    <AdminLayout title="Campaign Review">
      <div className="space-y-6">
        ...
        <Button
          variant="ghost"
          className="hover:bg-blue-700 w-auto px-2"
          size="icon"
          ...
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Review and approve or reject this campaign
              </p>
            </div>
          </div>
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <h4 className="font-robotobold text-blue-600">
                                {milestone.title}
                              </h4>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <p className="font-semibold">
                    {campaign.charity?.organizationName || "N/A"}
                  </p>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {actionDialog.type === "reject" &&
                "This will reject the campaign. Please provide a reason."}
              {actionDialog.type === "revision" &&
                "This will send the campaign back for revisions. Please specify what needs to be changed."}
            </DialogDescription>
          </DialogHeader>
