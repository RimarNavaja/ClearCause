  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 sticky top-24 font-poppinsregular">
      ...
      {isOwner ? (
        ...
        <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-md">
          <p className="text-sm text-purple-800 text-center">
            Charity accounts cannot make donations. Only donors can contribute
            to campaigns.
          </p>
        </div>
      ...
      <div className="mt-6 pt-6 border-t border-gray-100">
        <div className="flex items-start mb-4">
          <div className="mr-4">
            <div className="h-12 w-12 rounded-full overflow-hidden">
              <img
                src={campaign.charityLogo}
                alt={campaign.charity}
          ...
          <div>
            ...
            {campaign.charityId && (
              <Link
                ...
                className="text-sm text-clearcause-primary"
              >
                View Profile
              </Link>
            )}
        ...
        {campaign.status !== "draft" &&
          campaign.transparency > 0 &&
          campaign.efficiency > 0 && (
